               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"> <a href=/carelife/usermain"><img src="${pageContext.servletContext.contextPath}/resources/images/mainLogo.png" alt="logo" 
                     ...
                     <div class="limit-box" >
                        <nav class="main-menu" >
                           ...
                           <a href="#" class="dropdown-toggle" data-toggle="dropdown"> 예약 <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="/carelife/usermain/bookingparents"> 예약하기 </a></li>
                              <li><a href="/carelife/usermain/bookingcheck"> 예약 조회 </a></li>
                              <br>
                            </ul>
                              </li>
                             <li>
                           <a href="#" class="dropdown-toggle" data-toggle="dropdown"> 선생님 지원 <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                              <li><a href="/carelife/usermain/apply" > 선생님 지원 </a></li>
                              <li><a href="/carelife/usermain/passcheck"> 합격조회 </a></li>
                              <br>
                            </ul>
                              </li>
                           </ul>
